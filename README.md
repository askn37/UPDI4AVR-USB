...
Note that PDI type devices do not need to support HV control, so it is possible to create a PDI-only writer even from the AVR-DU14, which does not have a large number of pins.
