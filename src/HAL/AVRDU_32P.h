...
#define HAL_AVRDU_32P 32
#define HAL_PROFILE "HAL/AVRDU_32P.h"

/*
 * Pin layout by design: AVR16/32/64DU32
 *
 *                  -- Target-PGM Type --
 *         32P      UPDI    TPI     PDI     ISP (Future plans)
...
#if !defined(AVR_AVRDU) || !defined(PIN_PF2)
  #error The MCU family is not AVR_DU with 32-pads or more.
  #include BUILD_STOP
#endif
