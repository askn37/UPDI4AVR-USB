...
namespace SYS {
  ...
  void setup (void) {
    ...
    vportRegister(PIN_PGM_VPOWER).DIR   |= PIN_PGM_VPOWER;
  #endif
    ...
    portRegister(PIN_SYS_SW0).EVGENCTRLA = pinPosition(PIN_SYS_SW0)       /* PA5 */
                                         | pinPosition(PIN_VCP_RXD) << 4; /* PA3 */
    ...
    CCL_LUT1CTRLB = CCL_INSEL0_USART0_gc | CCL_INSEL1_EVENTA_gc;  /* <- EVS_CH4 */
